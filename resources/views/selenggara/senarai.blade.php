                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col">
                                        <form action="/selenggaraProjek" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mx-4">
                                                <div class="col-3 mb-2">
                                                ...
                                                <div class="col-7 mb-2">
                                                    <div class="row mt-4">
                                                        <div class="col-6">
                                                            <a href="/selenggaraProjek" class="btn btn-outline-primary">Batal</a>
                                                        </div>
                                                        <div class="col-6 text-end">
                                                            <button type="submit" class="btn btn-primary">Tambah</button>
                                                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col">
                                        <form action="/selenggaraKriteria" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mx-4">
                                                <div class="col-3 mb-2">
                                                ...
                                                <div class="col-7 mb-2">
                                                    <div class="row mt-4">
                                                        <div class="col-6">
                                                            <a href="/selenggaraKriteria" class="btn btn-outline-primary">Batal</a>
                                                        </div>
                                                        <div class="col-6 text-end">
                                                            <button type="submit" class="btn btn-primary">Tambah</button>
                                                        </div>
