...
<div class="container-fluid">
    <div class="row mb-3">
                ...
                @role('sekretariat')
                    ...
                    <form action="/projek/{{$projek->id}}/sah-eph-jalan-rayuan-baru" method="POST" enctype="multipart/form-data">
                        ...
                        @if($projek->status == "Selesai Jana Keputusan Rekabentuk Jalan Baru")
                            <button class="btn btn-primary" type="submit">Membuat Rayuan Jalan Baru</button>
                        @endif
                        @endrole
                        @role('sekretariat')
                        @if ($projek->status == "Proses Rayuan Rekabentuk Jalan Baru")
                            <button class="btn btn-primary" type="submit">Sahkan Proses Pengisian Rayuan Jalan Baru</button>
                        @endif
                        @endrole
                    </form>
            </div>
        ...
        @if ($projek->status == "Proses Pengisian Skor Rekabentuk Jalan Baru" ||
            ...
            <div class="tab mt-6">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab-1" role="tabpanel">
                        <div class="row mt-3">
                            <div class="card">
                                <div class="card-body" id="rumusan-skor-kad_">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col text-center">
                                            <button class="btn btn-primary" onclick="printJS('rumusan_skor_kad_', 'html')">Muat Turun</button>
                                        </div>
                                    </div>
                                    @endrole
                                </div>
                            ...
                            <div class="card-body">
                                <form action="/projek/{{ $projek->id }}/markah" method="POST"
                                    ...
                                    <div class="row mx-3 mb-2">
                                        ...
                                        <div class="col-7 mb-2">
                                            <input class="form-control" name="target_point" type="number" id="target_point"  />
                                        </div>
                                        <div class="col-5 mb-2">
                                            <label class="col-form-label">Assessment Point:</label>
                                        </div>
                                        ...
                                        <div class="col-7 mb-2">
                                            <textarea class="form-control" rows="3" name="comment" type="text" placeholder="Comment on Appeal"></textarea>
                                        </div>
                                        <div class="col-5 mb-2">
                                            <label class="col-form-label">Upload File:</label>
                                        </div>
