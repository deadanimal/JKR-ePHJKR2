            ...
            <div class="card">
                ...
                <form action="/projek/{{$projek->id}}/sah-gpss-jalan-rayuan" method="POST" enctype="multipart/form-data">
                    ...
                    @if($projek->status == "Selesai Pengesahan Verifikasi GPSS Jalan")
                        <button class="btn btn-primary mx-3 my-3" type="submit">Membuat Rayuan GPSS Jalan</button>
                    @endif
                    @endrole
                    @role('sekretariat')
                    @if ($projek->status == "Proses Rayuan GPSS Jalan")
                        <button class="btn btn-primary mx-3 my-3" type="submit">Sahkan Rayuan GPSS Bangunan</button>
                    @endif
                    @endrole
                </form>
            </div>
        ...
        <div class="tab mt-6">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-5" role="tabpanel">
                    <div class="card mt-3">
                        <div class="card-body"> 
                            <form action="/projek/{{ $projek->id }}/markah-gpss-jalan-rayuan" method="POST" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            @role('sekretariat')
                                <div class="row mt-3">
                                    <div class="col text-center">
                                        <a class="btn btn-primary" href="/projek/{{ $projek->id }}/sijil-gpss-jalan">Jana Sijil</a>
                                    </div>
                                </div>
                            @endrole
                            @role('ketua-pasukan|penolong-ketua-pasukan')
